import { MantineProvider, Text, Button, Flex, Title, TextInput, Card, BackgroundImage, Container } from "@mantine/core";
			...
			<Flex sx={{ height: "100%" }} gap="xl" justify="center" align="center" direction="column" wrap="nowrap">
				...
				>
					<Flex gap="xl" justify="center" align="center" direction="column" wrap="nowrap">
						...
						<Button sx={{ marginTop: "12px" }} size="xl" color="folly-pink.6">
							Login
						</Button>
					</Flex>
				</Card>
